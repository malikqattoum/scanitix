                        ...
                        <section id="requirements" style="display: none">
                            ...
                            <div class="table-responsive table-custom-container">
                                <table class="table table-custom">
                                    ...
                                    <tr>
                                        ...
                                        <td><?= PHP_VERSION ?></td>
                                        <td class="text-right">
                                            <?php if(version_compare(PHP_VERSION, '8.1.0', '>=') && version_compare(PHP_VERSION, '8.4', '<')): ?>
                                                ✅
                                            <?php else: ?>
                                                ❌
                            ...
                            <div class="table-responsive table-custom-container mt-5">
                                <table class="table table-custom">
                                    ...
                                    <tbody>
                                    <?php foreach(['config.php', 'uploads/main/', 'uploads/cache/', 'uploads/offline_payment_proofs/', 'uploads/blog/', 'uploads/pwa/', 'uploads/qr_codes/logo', 'uploads/favicons', 'uploads/barcodes', 'uploads/qr_code_background', 'uploads/qr_code_foreground'] as $key): ?>
                                        <tr>
                                            <td>/<?= $key ?></td>
                        ...
                        <section id="setup" style="display: none">
                            ...
                            <form id="setup_form" method="post" action="" role="form">
                                <div class="form-group">
                                    <label for="license_key">License key | Random value</label>
