...
return [
	...
	'global.plan_settings.barcodes_bulk_limit' => '<strong>%s</strong> Bulk Barcodes limit',
	...
	'barcodes.input.foreground_type_color' => 'Color',
	...
	'link_create.info' => 'You can configure the link further after its creation.',
	...
	'dashboard.barcodes_header' => 'Latest barcodes',
	...
	'index.testimonials.one.text' => 'Reliable and professional.
We use this tool to generate barcodes for all our product labels. The process is smooth, and the download options are perfect for printing',
	'index.testimonials.one.name' => 'Sara',
	'index.testimonials.one.attribute' => ' E-commerce Store Manager',
	'index.testimonials.two.text' => 'I was able to create a beautiful custom QR code for my restaurant menu in minutes. The ability to edit the link later is a lifesaver. Highly recommended!',
	'index.testimonials.two.name' => 'Adam',
	'index.testimonials.two.attribute' => 'Restaurant Owner',
	'index.testimonials.three.text' => 'Great analytics and support.
The dynamic QR codes with tracking helped us understand where our marketing campaign was most effective. Their support team was quick and helpful too!',
	'index.testimonials.three.name' => 'Patrick',
	'index.testimonials.three.attribute' => 'Marketing Specialist',
	'index.faq.header' => '%1$sAnswers%2$s for your common %1$squestions%2$s',
	'index.faq.one.question' => 'What types of codes can I generate?',
	'index.faq.one.answer' => 'You can generate various types of QR codes (URLs, text, Wi-Fi, email, phone number, location, etc.) and standard barcodes (EAN-13, Code 128, UPC, etc.) depending on your use case.',
	'index.faq.two.question' => 'Is the service free to use?',
	'index.faq.two.answer' => 'We offer a free plan with basic features. Premium features such as analytics, custom design, and dynamic QR codes are available on paid plans.',
	'index.faq.three.question' => 'What is a dynamic QR code?',
	'index.faq.three.answer' => 'Dynamic QR codes allow you to edit the content (e.g., URL) after printing without changing the actual code. They also enable you to track scan data such as location, device type, and scan count.',
	'index.faq.four.question' => 'Can I customize the QR code design?',
	'index.faq.four.answer' => 'Yes! You can change the colors, add a logo, set background colors, and more with our QR code designer',
	...
	'api_documentation.barcodes' => 'Barcodes',
