...
class ApiBarcodes extends Controller {
    ...
    private function patch() {
        ...
        $settings['foreground_color'] = $_POST['foreground_color'] = isset($_POST['foreground_color']) && preg_match('/#([A-Fa-f0-9]{3,4}){1,2}\b/i', $_POST['foreground_color']) ? $_POST['foreground_color'] : $barcode->settings->foreground_color;
