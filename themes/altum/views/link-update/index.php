        ...
        <div class="card-body">
            ...
            <form action="" method="post" role="form" enctype="multipart/form-data">
                ...
                <div class="form-group custom-control custom-switch">
                    ...
                    <label class="custom-control-label" for="is_enabled"><i class="fas fa-fw fa-sm fa-dot-circle text-muted mr-1"></i> <?= l('links.input.is_enabled') ?></label>
                </div>
                ...
                <div class="collapse" id="utm_container">
                    <div <?= $this->user->plan_settings->utm_parameters_is_enabled ? null : 'data-toggle="tooltip" title="' . l('global.info_message.plan_feature_no_access') . '"' ?>>
                        <div class="<?= $this->user->plan_settings->utm_parameters_is_enabled ? null : 'container-disabled' ?>">
                            ...
                            <div class="form-group">
                                ...
                                <input id="utm_campaign" type="text" class="form-control" name="utm_campaign" value="<?= $data->link->settings->utm->campaign ?? '' ?>" placeholder="<?= l('links.input.utm_campaign_placeholder') ?>" />
                            </div>
                ...
                <div class="collapse" id="cloaking_container">
                    ...
                    <div class="form-group" data-file-image-input-wrapper data-file-input-wrapper-size-limit="<?= settings()->links->opengraph_size_limit ?>" data-file-input-wrapper-size-limit-error="<?= sprintf(l('global.error_message.file_size_limit'), settings()->links->opengraph_size_limit) ?>">
                        ...
                        <?= include_view(THEME_PATH . 'views/partials/file_image_input.php', ['uploads_file_key' => 'opengraphs', 'file_key' => 'cloaking_opengraph', 'already_existing_image' => $data->link->settings->cloaking_opengraph]) ?>
