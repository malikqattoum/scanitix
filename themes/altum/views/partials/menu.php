                            ...
                            <div class="d-flex flex-column flex-lg-row">
                                <div class="pr-lg-3">
                                    ...
                                    <?php if(settings()->codes->qr_codes_is_enabled): ?>
                                        <a href="<?= \Altum\Authentication::check() ? url('qr-code-create') : url('qr') ?>" class="dropdown-item"><i class="fas fa-fw fa-sm fa-plus-circle mr-2"></i> <?= l('qr.menu') ?></a>
                                    ...
                                    <?php if(settings()->codes->barcodes_is_enabled): ?>
                                        ...
                                        <a href="<?= \Altum\Authentication::check() ? url('barcode-create') : url('barcode') ?>" class="dropdown-item"><i class="fas fa-fw fa-sm fa-plus-circle mr-2"></i> <?= l('barcode.menu') ?></a>
