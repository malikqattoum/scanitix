...
<div class="app-sidebar">
    ...
    <div class="overflow-auto flex-grow-1">
        <ul class="app-sidebar-links">
            ...
            <li class="<?= \Altum\Router::$controller == 'QrCodeCreate' ? 'active' : null ?>">
                <a href="<?= \Altum\Authentication::check() ? url('qr-code-create') : url('qr') ?>"><i class="fas fa-fw fa-sm fa-plus-circle mr-2"></i> <?= l('qr.menu') ?></a>
            </li>

            <li class="<?= in_array(\Altum\Router::$controller, ['QrCodes', 'QrCodeUpdate']) ? 'active' : null ?>">
            ...
            <li class="<?= in_array(\Altum\Router::$controller, ['Links', 'LinkUpdate', 'LinkCreate', 'LinkStatistics']) ? 'active' : null ?>">
            ...
            <?php if(settings()->codes->barcodes_is_enabled): ?>
                ...
                <li class="<?= \Altum\Router::$controller == 'BarcodeCreate' ? 'active' : null ?>">
                    <a href="<?= \Altum\Authentication::check() ? url('barcode-create') : url('barcode') ?>"><i class="fas fa-fw fa-sm fa-plus-circle mr-2"></i> <?= l('barcode.menu') ?></a>
                </li>

                <li class="<?= in_array(\Altum\Router::$controller, ['Barcodes', 'BarcodeUpdate']) ? 'active' : null ?>">
