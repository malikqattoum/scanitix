            ...
            <?php foreach($data->domains as $row): ?>
                ...
                <tr>
                    ...
                    <td class="text-nowrap">
                        ...
                        <a href="<?= $row->scheme . $row->host ?>" rel="noreferrer noopener"><i class="fas fa-fw fa-xs fa-external-link-alt text-muted ml-1"></i></a>
                    </td>

                    <td class="text-nowrap">
                        <?php if($row->type == 1): ?>
                            <span class="badge badge-primary">
                                <i class="fas fa-fw fa-sm fa-globe mr-1"></i> <?= l('admin_domains.main.type_global') ?>
                            </span>
                        <?php elseif($row->type == 0): ?>
                            <span class="badge badge-light">
                                <i class="fas fa-fw fa-sm fa-user mr-1"></i> <?= l('admin_domains.main.type_user') ?>
                            </span>
                        <?php endif ?>
                    </td>
