...
<div class="dropdown">
    ...
    <div class="dropdown-menu dropdown-menu-right">
        <a class="dropdown-item" href="<?= $data->type == 'internal' ? SITE_URL . ($data->language ? \Altum\Language::$active_languages[$data->language] . '/' : null) . 'page/' . $data->url : $data->url ?>" target="_blank" rel="noreferrer noopener"><i class="fas fa-fw fa-sm fa-eye mr-2"></i> <?= l('global.view') ?></a>
