    ...
    <table class="table table-custom">
        ...
        <?php foreach($data->links as $row): ?>
            <tr>
                ...
                <td class="text-nowrap">
                    <div class="d-flex flex-column">
                        <div><?= $row->url ?><a href="<?= url('link-redirect/' . $row->link_id) ?>" rel="noreferrer noopener" target="_blank"><i class="fas fa-fw fa-xs fa-external-link-alt text-muted ml-1"></i></a></div>

                        <div class="small text-muted">
                            <img src="<?= get_favicon_url_from_domain(parse_url($row->location_url)['host']) ?>" class="img-fluid icon-favicon-small mr-1" loading="lazy" />
                            ...
                            <a href="<?= $row->location_url ?>" target="_blank" rel="noreferrer noopener">
