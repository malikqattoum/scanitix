                        ...
                        <form id="form" action="<?= url('qr-code-create') ?>" method="post" role="form" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row btn-group-toggle" data-toggle="buttons">
                                        <?php foreach(['square' => 'fas fa-square-full', 'dot' => 'fas fa-circle', 'round' => 'fas fa-square', 'heart' => 'fas fa-heart', 'diamond' => 'fas fa-gem'] as $key => $icon): ?>
                                            <div class="col-6">
                                                <label class="btn btn-light btn-block text-truncate <?= ($data->values['settings']['style'] ?? 'square') == $key ? 'active"' : null?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row btn-group-toggle" data-toggle="buttons">
                                        <?php foreach(['square' => 'fas fa-square-full', 'dot' => 'fas fa-circle', 'rounded' => 'fas fa-square', 'diamond' => 'fas fa-gem', 'flower' => 'fas fa-seedling', 'leaf' => 'fas fa-leaf'] as $key => $icon): ?>
                                            <div class="col-6">
                                                <label class="btn btn-light btn-block text-truncate <?= ($data->values['settings']['inner_eye_style'] ?? 'square') == $key ? 'active"' : null?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row btn-group-toggle" data-toggle="buttons">
                                        <?php foreach(['square' => 'fas fa-square-full', 'circle' => 'fas fa-circle', 'rounded' => 'fas fa-square', 'flower' => 'fas fa-seedling', 'leaf' => 'fas fa-leaf'] as $key => $icon): ?>
                                            <div class="col-6">
                                                <label class="btn btn-light btn-block text-truncate <?= ($data->values['settings']['outer_eye_style'] ?? 'square') == $key ? 'active"' : null?>">
                            ...
                            <div class="collapse" id="frame_container" data-parent="#form">
                                ...
                                <div class="form-group" data-frame-custom-colors="on">
                                    ...
                                    <input type="hidden" id="frame_color" name="frame_color" class="form-control <?= \Altum\Alerts::has_field_errors('frame_color') ? 'is-invalid' : null ?>" value="#000000" data-reload-qr-code data-color-picker />
                                    <?= \Altum\Alerts::output_field_error('frame_color') ?>
                                </div>

                                <div class="form-group" data-frame-custom-colors="on">
                                    <label for="frame_text_color"><?= l('qr_codes.input.frame_text_color') ?></label>
                                    <input type="hidden" id="frame_text_color" name="frame_text_color" class="form-control <?= \Altum\Alerts::has_field_errors('frame_text_color') ? 'is-invalid' : null ?>" value="#ffffff" data-reload-qr-code data-color-picker />
